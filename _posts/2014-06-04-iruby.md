...
Buňky v dokumentu mohou být různých typů -- kromě samotného kódu i bloky textu psané v Markdownu nebo nadpisy různých úrovní (pro lepší strukturování). Vedle toho může buňka nést i různá metadata, což se hodí především pro tvorbu prezentací ([popisuji níže](#slidemode)). Metadata buňky lze editovat přes <i lang="en">Cell Toolbar</i>.
